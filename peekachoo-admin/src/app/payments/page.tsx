...
export default function PaymentsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'settled':
        return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">Settled</span>;
      case 'captured':
        return <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">Captured</span>;
      case 'pending':
    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-card border rounded-lg p-4">
            <div className="text-sm text-muted-foreground">Total Revenue (SGD)</div>
            <div className="text-2xl font-bold text-green-500">S${totalRevenue.toFixed(2)}</div>
          </div>
          <div className="bg-card border rounded-lg p-4">
              ...
              {payments.length === 0 ? (
                ...
                payments.map((payment) => (
                  <TableRow key={payment.id}>
                    ...
                    <TableCell className="text-right font-mono">{payment.quantity}</TableCell>
